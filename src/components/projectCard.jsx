      ...
      <div className="w-full md:flex-1 flex flex-col justify-between self-stretch">
        ...
        <div>
          ...
          <div className="flex gap-6">
            {project.github && (<a href={project.github} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-slate-500 font-medium hover:text-brand transition-colors duration-300"><FiGithub size={18} /><span>GitHub</span></a>)}
            {project.demo && (<a href={project.demo} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-slate-500 font-medium hover:text-brand transition-colors duration-300"><FiExternalLink size={18} /><span>Live Demo</span></a>)}
          </div>
        </div>
      </div>
